...
const { fetchTopics, fetchArticleById, fetchAllArticles, fetchArticleComments,postArticleComments } = require("./model");
...
module.exports = { getTopics, getArticleById, getAllArticles, getArticleComments,addArticleComments };
